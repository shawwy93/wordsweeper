...
export default function CrossMenuScreen(props: {
  onPlay: () => void;
  onResume: () => void;
  onStartOver: () => void;
  onStats: () => void;
    ...
    <div className="screen screenMenu">
      <div className="menuLayout">
        ...
        <div className="menuStack">
          ...
          <button className="menuAction" type="button" onClick={handleStartOver}>
            Start Over
          </button>
          <div className="menuSecondary">
            ...
            <button className="menuSecondaryAction" type="button" onClick={handleBack}>
              Home
            </button>
          </div>
